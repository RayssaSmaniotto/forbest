...
public class UsuarioModel {
    ...
    private int codigo,idade,numeroLocal,numero;
    private String nome, sobrenome, email, razaoSocial, cnpj, cpf, cep, estado, cidade, logradouro;
