...
=======
>>>>>>> 4a1393fc6f3214cc1df9de1928e33810f5fa625a
...
>>>>>>> 4a1393fc6f3214cc1df9de1928e33810f5fa625a
  ...
  <div class="menu-superior">
    ...
    <div class="info-desenvolvimento">
      ...
      <p id="titulo-a">A mudança começa Agora!</p>
      <p id="titulo-b">Ajude do conforto de sua casa, e saiba se seu investimento foi bem utilizado. Apoie as causas que valem a pena</p>
    ...
    <div class="info-meio">
      ...
      <p id="titulo-meio2"> Existem muitas pessoas e instituições que lutam por causas nobres, que ajudam animais e idosos, fornecem suprimentos, abrigo e proteção para os nescessitados, que auxiliam os depedente químicos ou animais abandonados. Também tem os eventos que buscam repor a flora ou que lutam pela sociedade de demasiadas formas. </p>
    </div>



    <div class="info-desenvolvimento2">
      <div class="info-desenvolvimento2-coluna2">
        <i class="fa fa-handshake-o fa-5x" aria-hidden="true"></i>
        <i class="fa fa-credit-card-alt fa-4x" aria-hidden="true"></i>
      </div>
      <p id="titulo-c">Conheça pessoas, instituições e eventos!</p>
      <p id="titulo-d">Através desta rede social você pode apoiar e até ajudar financeiramente pessoas, instituições e eventos, podendo acompanhar tudo que está acontecendo</p>
    </div>
